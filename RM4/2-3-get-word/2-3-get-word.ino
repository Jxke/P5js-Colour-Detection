...
String board_id = "Jake's tiny computer";

// base address for the server that's listening for incoming data
String server = "interactive-checkin.glitch.glitch.me/word";  // <-- this should change to your app's address
